...
| Param         | Type                                                                                      | Description                                                                    |
| ------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| **`options`** | <code><a href="#capsqliteimportdatabaseoptions">capSQLiteImportDatabaseOptions</a></code> | : <a href="#capsqliteimportdatabaseoptions">capSQLiteImportDatabaseOptions</a> |
...
| Prop             | Type                                                                    | Description                                                                                                                                                                                                                                  |
| ---------------- | ----------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **`database`**   | <code>string</code>                                                     | The database name, without the "SQLite.db" suffix, exactly as createConnection takes it                                                                                                                                                      |
| **`source`**     | <code><a href="#capsqliteimportsource">capSQLiteImportSource</a></code> | The bytes to import                                                                                                                                                                                                                          |
| **`overwrite`**  | <code>boolean</code>                                                    | Replace an existing database of that name. Absent or "false" rejects when the name is already taken. An overwrite briefly needs room for three copies of the database: the old one, the staged import and the copy being written into place. |
| **`totalBytes`** | <code>number</code>                                                     | Total byte length, for progress reporting when the source cannot report its own. A ReadableStream never knows its length; a Blob and a <a href="#uint8array">Uint8Array</a> always do.                                                       |
